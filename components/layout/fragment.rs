...
pub struct Fragment {
    ...
    /// The damage done to this fragment during the current layout round.
    pub restyle_damage: incremental::RestyleDamage,
...
impl ImageFragmentInfo {
    ...
    pub fn image_inline_size(&mut self) -> Au {
        ...
        let ret = Au::from_px(if self.writing_mode_is_vertical { size.height } else { size.width });
        ret
    }
...
impl Fragment {
    ...
    pub fn from_opaque_node_and_style(node: OpaqueNode,
                                      ...
                                      damage: incremental::RestyleDamage,
            ...
            ImageFragment(_) => {
                match self.specific {
                    ImageFragment(ref mut image_fragment) => {
                        debug!("Got specific image fragment: {}", image_fragment.image.url().serialize());
